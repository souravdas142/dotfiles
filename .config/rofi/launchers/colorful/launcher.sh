...
themes=( zorin_menu style_{1,5,7,9,11,12}.rasi )
theme="${themes[$(( $RANDOM % 7 ))]}"
[[ $theme -eq "zorin_menu" ]] && $HOME/.config/rofi/launchers/colorful/zorin_menu ||  rofi -no-lazy-grab -show drun -modi drun -theme $dir/"$theme"
